...
public class JoueurInter {
	...
	public void create () {
		...
		attackHitbox = new Rectangle(linkX, linkY, 55, 55);
...
//				System.out.println(hitbox.overlaps(monstre.getHitbox()));
		...
		if(Gdx.input.isKeyPressed(Keys.E)) {
			...
			case 1:
				attackHitbox.setPosition(linkX - 15, linkY);
//				System.out.println(attackHitbox.getX());
//				System.out.println(hitbox.getX());
				break;
			case 2 :
				attackHitbox.setPosition(linkX, linkY + 15);
//				System.out.println(attackHitbox.getY());
				System.out.println(hitbox.getX());
				System.out.println(hitbox.getY());
//				System.out.println(monstres.get(0).getHitbox().getY());
				break;
			case 3 :
				attackHitbox.setPosition(linkX + 15, linkY);
//				System.out.println(attackHitbox.getY());
...
//					System.out.println("--------------------------");
//					System.out.println(attackHitbox.overlaps(monstre.getHitbox()));
					collisionAttack = attackHitbox.overlaps(monstre.getHitbox());
					if(collisionAttack) {
						monstre.setMonstreX(100);
						monstre.setMonstreY(100);
		...
		attackHitbox.setPosition(linkX, linkY);
	}
